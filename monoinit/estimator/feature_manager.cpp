...
extern const int NUM_OF_CAM = 1;
extern int FOCAL_LENGTH;
extern int MIN_PARALLAX;
...
bool FeatureManager::addFeatureCheckParallax(int frame_count, const map<int, vector<pair<int, Eigen::Matrix<double, 5, 1>>>> &image)
{
