...
# You should provide feature message for each frame and acc calibration file.
...
# 1. calibration.dat
# 2. acc folder called 'dat' which contains .dat files that correspond to frames one by one
...
# Then, there will be acc calibration file: /home/dataset/EuRoC/calibration.dat,
# and acc folder contains lots of dat files correspond to your input images one by one: /home/dataset/EuRoC/dat/*.dat
